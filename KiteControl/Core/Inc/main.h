...
#define SLP_A_Pin GPIO_PIN_2
#define SLP_A_GPIO_Port GPIOB
...
#define END_A1_Pin GPIO_PIN_8
#define END_A1_GPIO_Port GPIOA
#define END_A2_Pin GPIO_PIN_9
#define END_A2_GPIO_Port GPIOA
